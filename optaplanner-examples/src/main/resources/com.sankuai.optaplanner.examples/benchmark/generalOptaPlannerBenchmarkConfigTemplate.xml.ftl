...
<plannerBenchmark>
  ...
  <solverBenchmark>
    ...
    <solver>
      ...
      <randomType>${randomType}</randomType>
      <scoreDirectorFactory>
        <scoreDrl>com/sankuai/optaplanner/examples/examination/solver/examinationConstraints.drl</scoreDrl>
      </scoreDirectorFactory>
      <constructionHeuristic>
        <queuedEntityPlacer>
  ...
  <solverBenchmark>
    ...
    <solver>
      ...
      <randomType>${randomType}</randomType>
      <scoreDirectorFactory>
        <scoreDrl>com/sankuai/optaplanner/examples/nurserostering/solver/nurseRosteringConstraints.drl</scoreDrl>
      </scoreDirectorFactory>
      <constructionHeuristic>
  ...
  <solverBenchmark>
    ...
    <solver>
      ...
      <randomType>${randomType}</randomType>
      <scoreDirectorFactory>
        <scoreDrl>com/sankuai/optaplanner/examples/travelingtournament/solver/travelingTournamentConstraints.drl</scoreDrl>
      </scoreDirectorFactory>
      <localSearch>
        <unionMoveSelector>
          <swapMoveSelector>
