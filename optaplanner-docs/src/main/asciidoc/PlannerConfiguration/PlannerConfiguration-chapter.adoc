...
that solverConfig XML file would be located at ``$PROJECT_DIR/src/main/resources/com/sankuai/optaplanner/examples/nqueens/solver/nqueensSolverConfig.xml``.
...
<solver xmlns="https://www.optaplanner.org/xsd/solver" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
  ...
  <!-- Define the model -->
  <solutionClass>com.sankuai.optaplanner.examples.nqueens.domain.NQueens</solutionClass>
  <entityClass>com.sankuai.optaplanner.examples.nqueens.domain.Queen</entityClass>

  <!-- Define the score function -->
  <scoreDirectorFactory>
    <scoreDrl>com/sankuai/optaplanner/examples/nqueens/solver/nQueensConstraints.drl</scoreDrl>
  </scoreDirectorFactory>
...
or a property on a `$$*$$Config` class in the package namespace ``com.sankuai.optaplanner.core.config``.
These `$$*$$Config` classes are the Java representation of the XML format.
They build the runtime components (of the package namespace ``com.sankuai.optaplanner.core.impl``)
...
Configure the logging level on the `com.sankuai.optaplanner` package in your `logback.xml` file:

[source,xml,options="nowrap"]
----
<configuration>

  <logger name="com.sankuai.optaplanner" level="debug"/>
...
And configure the logging level on the package `com.sankuai.optaplanner` in your `log4j.xml` file:

[source,xml,options="nowrap"]
----
<log4j:configuration xmlns:log4j="http://jakarta.apache.org/log4j/">

  <category name="com.sankuai.optaplanner">
