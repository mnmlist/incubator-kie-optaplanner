...
<log4j:configuration xmlns:log4j="http://jakarta.apache.org/log4j/" debug="false">
  ...
  <logger name="com.sankuai.optaplanner">
    <level value="debug"/>
  </logger>
...
Let's create a module called __com.sankuai.optaplanner__:

. Navigate to the directory ``${WILDFLY_HOME}/modules/system/layers/base/``. This directory contains the JBoss modules of WildFly. Create directory structure `com/sankuai/optaplanner/main` for our new module.
...
----
<?xml version="1.0" encoding="UTF-8"?>
<module xmlns="urn:jboss:module:1.3" name="com.sankuai.optaplanner">
  <resources>
    ...
...
<jboss-deployment-structure>
   <deployment>
      <dependencies>
         <module name="com.sankuai.optaplanner" export="true"/>
      </dependencies>
   </deployment>
</jboss-deployment-structure>
----
...
[source,java,options="nowrap"]
----
module com.sankuai.optaplanner.cloudbalancing {
    requires com.sankuai.optaplanner.core;
    ...

    opens com.sankuai.optaplanner.examples.cloudbalancing.domain; // Domain classes
    opens com.sankuai.optaplanner.examples.cloudbalancing.solver; // DRL file and solver configuration
    ...
}
----
...
dependencies {
    ...
    compile('com.sankuai.optaplanner:optaplanner-core:...') {
...
** Debug logging `com.sankuai.optaplanner` can be between 0% and 15% slower than info logging. Trace logging can be between 5% and 70% slower than info logging.
