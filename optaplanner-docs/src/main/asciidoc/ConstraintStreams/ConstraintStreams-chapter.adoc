...
|3          |`com.sankuai.optaplanner.core.api.function.TriPredicate<A, B, C>`
|4          |`com.sankuai.optaplanner.core.api.function.QuadPredicate<A, B, C, D>`
|===
...
[source,java,options="nowrap"]
----
    import static com.sankuai.optaplanner.core.api.score.stream.Joiners.*;
...
`com.sankuai.optaplanner.core.api.score.stream.Joiners` class.
...
`com.sankuai.optaplanner.core.api.score.stream.uni.UniConstraintCollector` interface, or its `Bi...`, `Tri...` counterparts.
