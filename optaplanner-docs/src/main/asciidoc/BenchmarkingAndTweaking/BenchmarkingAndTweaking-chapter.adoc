...
----
    <dependency>
      <groupId>com.sankuai.optaplanner</groupId>
...
PlannerBenchmarkFactory benchmarkFactory = PlannerBenchmarkFactory.createFromXmlResource(
        "com/sankuai/optaplanner/examples/cloudbalancing/benchmark/cloudBalancingBenchmarkConfig.xml");
PlannerBenchmark benchmark = benchmarkFactory.buildPlannerBenchmark();
benchmark.benchmarkAndShowReportInBrowser();
----
...
----
    <problemBenchmarks>
      <solutionFileIOClass>com.sankuai.optaplanner.examples.nqueens.persistence.NQueensXmlSolutionFileIO</solutionFileIOClass>
...
----
    <problemBenchmarks>
      <solutionFileIOClass>com.sankuai.optaplanner.examples.nqueens.persistence.NQueensJsonSolutionFileIO</solutionFileIOClass>
