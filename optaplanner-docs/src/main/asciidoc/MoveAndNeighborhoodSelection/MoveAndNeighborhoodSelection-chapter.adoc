...
----
    <pillarChangeMoveSelector>
      ...
      <subPillarSequenceComparatorClass>com.sankuai.optaplanner.examples.nurserostering.domain.ShiftAssignmentComparator</subPillarSequenceComparatorClass>
      ... <!-- Normal selector properties -->
      <pillarSelector>
        <entitySelector>
...
----
    <unionMoveSelector>
      <selectorProbabilityWeightFactoryClass>com.sankuai.optaplanner.core.impl.heuristic.selector.common.decorator.FairSelectorProbabilityWeightFactory</selectorProbabilityWeightFactoryClass>
      <changeMoveSelector/>
      <swapMoveSelector/>
    </unionMoveSelector>
----
...
----
    <changeMoveSelector>
      <entitySelector>
        <filterClass>com.sankuai.optaplanner.examples.curriculumcourse.solver.move.LongLectureSelectionFilter</filterClass>
      </entitySelector>
    </changeMoveSelector>
----
...
----
    <changeMoveSelector>
      <valueSelector>
        <filterClass>com.sankuai.optaplanner.examples.curriculumcourse.solver.move.LongPeriodSelectionFilter</filterClass>
      </valueSelector>
    </changeMoveSelector>
----
...
----
    <moveListFactory>
      <moveListFactoryClass>com.sankuai.optaplanner.examples.cloudbalancing.optional.solver.move.CloudComputerChangeMoveFactory</moveListFactoryClass>
    </moveListFactory>
----
